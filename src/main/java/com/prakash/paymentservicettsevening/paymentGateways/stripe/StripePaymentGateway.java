package com.prakash.paymentservicettsevening.paymentGateways.stripe;
...
public class StripePaymentGateway implements PaymentGateway {
    ...
    public String generatePaymentLink(Long amount, String orderId) throws StripeException {
        ...
        ProductCreateParams params =
                ProductCreateParams.builder().setName("Generic Product").build();
        Product product = Product.create(params);

        PriceCreateParams priceCreateParams =
                PriceCreateParams.builder()
                        .setCurrency("inr")
                        .setUnitAmount(amount) // to handle decimal, we sent real_amount*100
